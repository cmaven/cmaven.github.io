...
description: "엑셀에서 조건부 서식과 MOD 함수를 활용하여 정수와 소수를 셀별로 다르게 표시하는 방법"
excerpt: "MOD 함수 + 조건부 서식으로 정수는 정수로, 실수는 소수점 2자리까지 표시하는 엑셀 설정법"
date: 2022-03-18
categories: Excel
tags: [Excel, MOD, 조건부서식, 소수점표시, 셀서식, 엑셀함수]
---
