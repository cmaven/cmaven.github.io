...
ref: install-hangul-ubuntu
---

:bulb: 영문으로 설치된 Ubuntu 16.04 환경에서 fcitx-hangul을 이용해 한글 입력을 활성화하고 한영 전환 단축키를 설정하는 방법을 정리한다.
{: .notice--info}
...
# [03] 단축키 (한/영) 전환 설정 — Ubuntu Setting 사용
...
1. AllSettings - Keyboard - Shortcuts Tab - Typing
   ...
   *그림 4. Keyboard Shortcuts - Typing 탭*
...
2. Disable 설정
   ...
   *그림 5. 기존 단축키 Disable 처리*

   * 옵션 부분 클릭 후, 백스페이스 키를 누르면 Disable로 변경 가능함
...
3. Compose Key 옵션 = Right Alt 및 Switch to next source 옵션 = Multikey
   ...
   *그림 6. Compose Key 및 Multikey 설정*
...
4. 바탕화면 키보드 레이아웃 설정(오른쪽 상단의 키보드 표시) - Configure Current Input Method
   ...
   *그림 7. Configure Current Input Method 진입*
...
6. Global Config 설정
   ...
   *그림 9. Global Config - Trigger Input Method 설정*

# [04] 단축키 설정 — 프로그램(dconf-Editor) 사용
...
*그림 10. Switch to next source 오류 화면*
