...
description: "오브젝트 스토리지의 개념, 장점(확장성/효율성/가용성), IDA 분산 저장 동작 원리 정리"
excerpt: "비정형 데이터 저장에 적합한 오브젝트 스토리지의 개념과 동작 원리"
date: 2018-02-23
categories: Storage
tags: [Object-Storage, 스토리지, IDA, 비정형데이터, 분산저장, 클라우드스토리지]
---
