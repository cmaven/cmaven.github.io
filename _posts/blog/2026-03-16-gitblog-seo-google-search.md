...
- 버전 정보(`Ubuntu-22.04`)를 포함하여 특정 버전 검색에 대응
...
<title>Ubuntu 22.04 한글 입력기 설치 및 한영 전환 설정 - 블로그</title>

<!-- jekyll-seo-tag 적용 후 (자동 생성) -->
<title>Ubuntu 22.04 한글 입력기 설치 및 한영 전환 설정 - 블로그</title>
<meta name="description" content="Ubuntu 22.04에서 fcitx, ibus 한글 입력기 설치 방법과 한영 전환 단축키 설정 가이드">
<meta property="og:title" content="Ubuntu 22.04 한글 입력기 설치 및 한영 전환 설정">
<meta property="og:description" content="Ubuntu 22.04에서 fcitx, ibus ...">
<meta property="og:type" content="article">
<meta name="twitter:card" content="summary">
<link rel="canonical" href="https://xxx.github.io/linux/ubuntu-2204-korean-input-setup/">
```
...
# → /linux/2026/03/16/ubuntu-2204-korean-input-setup/

# 간결한 형태 (권장)
permalink: /:categories/:title/
# → /linux/ubuntu-2204-korean-input-setup/
```
...
```
# 좋은 예 - 키워드가 명확
2026-03-16-ubuntu-2204-korean-input-setup.md
